module github.com/leoarry/packer-plugin-proxmox-lxc
...
// Required because packer-plugin-sdk uses cty.GobEncode which was removed in go-cty v1.11.0
// and hcl/v2 v2.24.0 needs go-cty >= v1.12.0 (for RefinementBuilder).
// These two replace directives pin compatible versions.
